...
- [x] **INGEST-04**: System deduplicates stories covering the same event using near-match detection
...
| INGEST-04 | Phase 1 | Complete (01-04: two-phase dedup + pgvector clustering) |
